...
const AdminRegister = () => {
  ...
  const validateForm = () => {
    ...
    if (!input.phone.trim() || !phoneReg.test(input.phone)) {
  ...
  return (
    <div className="min-h-screen bg-[#252424] flex flex-col items-center justify-center p-6 relative">
      <button
        onClick={() => navigate(-1)}
        className="absolute top-8 left-8 flex items-center gap-2 text-slate-500 hover:text-green-700 transition-colors font-medium bg-gray-800 px-4 py-2 rounded-full shadow-sm border border-indigo-500"
      >
        <ArrowLeft size={18} />
        <span>Back</span>
      </button>

      <div className="w-full max-w-5xl bg-gray-800 rounded-[2.5rem] shadow-2xl shadow-slate-200/50 overflow-hidden flex flex-col md:flex-row border border-indigo-500">
        ...
        <div className="md:w-1/3 bg-slate-900 p-10 text-white flex flex-col justify-between">
          <div>
            ...
            <h1 className="text-3xl font-bold leading-tight">Admin Gateway</h1>
        ...
        <div className="flex-1 p-8 md:p-12">
          ...
          <form onSubmit={submitHandler} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3 bg-gray-800 border border-indigo-500 rounded-2xl outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-600 transition-all text-sm"
                    required
                  />
              ...
              <div className='sapce-y-1.5  grid-row-2'>
                <h2 className="text-lg font-bold mb-4 text-gray-800">
                  Select Role
                </h2>

                <div className='flex gap-6 items-center '>
                  <label className="flex items-center gap-2 p-2 border rounded-lg cursor-pointer hover:bg-gray-900">
                    <input
                      type="radio"
                      name="role"
                      value="admin"
                ...
                <div className="mt-2 text-sm text-gray-600">
                  Selected Role: <span className="font-bold">{input.role}</span>
                </div>
              </div>
            </div>

            <div className="bg-gray-800 border border-indigo-500 rounded-2xl p-5">
            ...
            <div className="flex flex-col md:flex-row gap-4 pt-4">
              ...
              <button
                type="button"
                onClick={() => navigate(-1)}
                className="px-8 py-4 bg-gray-800 border border-indigo-500 text-indigo-400 rounded-2xl font-semibold hover:bg-gray-900 transition-colors"
              >
                Cancel
              </button>
            </div>

...
const SellerPasswordChange = () => {
  ...
  const changePassword = useChangePassword("seller");
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-6">
        ...
        <form onSubmit={submitHandler} className="space-y-5">
          ...
          <div className="flex gap-4 pt-3">
            <button type="submit" disabled={loading} className="flex-1 bg-green-600 hover:bg-green-700 text-white py-2 rounded-xl font-semibold">
              {loading ? "Updating..." : "Update Password"}
            </button>

            <button type="button" onClick={() => navigate(-1)} className="flex-1 border border-gray-300 text-gray-600 py-2 rounded-xl hover:bg-gray-50">
              Cancel
            </button>
          </div>
        </form>

...
const BuyerRegister = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      if (res.data.success) navigate("/buyer/login")
    } catch (error) {
      console.log(error)
    }
  }
  ...
  return (
    <div className=" min-h-screen flex flex-col md:flex-row lg:flex-row items-center justify-center gap-12 bg-gradient-to-br from-orange-200 to-green-200">
      <img
        src="/crop1.png"
        alt="crop"
      ...
      <form
        ...
        className=" w-full max-w-4xl  bg-white shadow-xl p-8 space-y-8">

...
const BuyerLogin = () => {
  ...
  const validateForm = () => {
    ...
    // Login should NOT require strong password validation
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f7fee7] relative overflow-hidden px-4">
      ...
      <button
        onClick={() => navigate("/")}
        className="absolute top-6 left-6 z-20 flex items-center gap-2 text-gray-500 hover:text-emerald-700 transition-colors font-bold"
      >
        <ArrowLeft size={20} />
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between items-center ml-1">
                ...
                <button
                  type="button"
                  onClick={() =>
                    navigate("/forgot-password/buyer")
                  }

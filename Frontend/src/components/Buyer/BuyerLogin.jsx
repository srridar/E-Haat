...
const BuyerLogin = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row lg:flex-row items-center justify-center bg-gradient-to-br from-orange-300 to-green-100 gap-12  px-4">
      <img
        src="/crop1.png"
        alt="crop"
      ...
      >
        ...
        <div className="text-center space-y-1">
          ...
          <p className="text-sm text-gray-500">
            Access your E-Haat seller dashboard
          </p>

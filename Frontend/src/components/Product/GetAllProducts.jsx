        ...
        <section className="relative overflow-hidden bg-slate-900 rounded-[2.5rem] mb-12 shadow-2xl">
          ...
          <div className="relative px-10 py-10 md:py-14 flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="flex-1 w-full max-w-md hidden lg:block">
              <div className="bg-gradient-to-br from-indigo-600 to-violet-700 p-10 rounded-[3rem] shadow-2xl relative">
                <div className="absolute top-0 right-0 p-8 opacity-10"><Truck size={120} /></div>
                <div className="space-y-6 relative z-10">
                  <span className="px-3 py-1 bg-white/20 rounded-lg text-white text-xs font-bold uppercase tracking-widest">Flash Sale</span>
                  <h3 className="text-4xl font-black text-white italic tracking-tight">SAVE 20%</h3>
                  <p className="text-indigo-100 text-lg">On your first intra-city delivery booking this month.</p>
                  <div className="bg-black/20 backdrop-blur-md rounded-2xl p-5 border border-white/10">
                    <p className="text-[10px] text-indigo-300 uppercase font-bold mb-1">Promo Code</p>
                    <p className="text-2xl font-mono font-bold text-white tracking-[0.3em]">GOFLEET26</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div id="main" className="flex flex-col lg:flex-row gap-4">
          ...
          <main className="flex-1 space-y-6">
            <header className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 px-2">
              <div>
                <h2 className="text-3xl font-black text-slate-900 tracking-tight">Verified Goods</h2>

...
const TransporterRegister = () => {
  ...
  return (
    <div className=" min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-300 to-green-200">
      <form
        onSubmit={submitHandler}
        className=" w-full max-w-3xl  bg-white overflow-scroll rounded-3xl shadow-xl p-8 space-y-8">
        ...
        <div className="bg-[var(--background-light)] rounded-2xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
              { label: "Name", name: "name", placeholder: "Your transportation profile name" },
